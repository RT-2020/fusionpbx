...
$text['title-access_control_export']['es-cl'] = "Exportación de Control de Acceso";
$text['title-access_control_export']['es-mx'] = "Exportación de Control de Acceso";
$text['title-access_control_export']['fr-ca'] = "Exporter le contrôle d'accès";
$text['title-access_control_export']['fr-fr'] = "Exporter le contrôle d'accès";
$text['title-access_control_export']['he-il'] = "تصدير שליטת גישה";
$text['title-access_control_export']['it-it'] = "Esportazione Controllo Accesso";
$text['title-access_control_export']['ka-ge'] = "წვდომის კავშირების გატაცება";
$text['title-access_control_export']['nl-nl'] = "Export toegangscontrole";
$text['title-access_control_export']['pl-pl'] = "Eksport kontroli dostępu";
$text['title-access_control_export']['pt-br'] = "Exportar Controle de Acesso";
$text['title-access_control_export']['pt-pt'] = "Exportar Controlo de Acesso";
$text['title-access_control_export']['ro-ro'] = "Export Control Acces";
$text['title-access_control_export']['ru-ru'] = "Экспорт контроля доступа";
$text['title-access_control_export']['sv-se'] = "Exporteringskontroll för åtkomst";
$text['title-access_control_export']['uk-ua'] = "Експорт керування доступом";
$text['title-access_control_export']['tr-tr'] = "Erişim Kontrolu Dışa Aktarımı";
$text['title-access_control_export']['zh-cn'] = "导出访问控制";
$text['title-access_control_export']['ja-jp'] = "アクセス制御のエクスポート";
...
$text['header-access_control_export']['de-at'] = "Export des Zugriffskontrolls";
...
$text['header-access_control_export']['es-cl'] = "Exportación de Control de Acceso";
$text['header-access_control_export']['es-mx'] = "Exportación de Control de Acceso";
$text['header-access_control_export']['fr-ca'] = "Exporter le contrôle d'accès";
$text['header-access_control_export']['fr-fr'] = "Exporter le contrôle d'accès";
$text['header-access_control_export']['he-il'] = "تصدير שליטת גישה";
$text['header-access_control_export']['it-it'] = "Esportazione Controllo Accesso";
$text['header-access_control_export']['ka-ge'] = "წვდომის კავშირების გატაცება";
$text['header-access_control_export']['nl-nl'] = "Export toegangscontrole";
$text['header-access_control_export']['pl-pl'] = "Eksport kontroli dostępu";
$text['header-access_control_export']['pt-br'] = "Exportar Controle de Acesso";
$text['header-access_control_export']['pt-pt'] = "Exportar Controlo de Acesso";
$text['header-access_control_export']['ro-ro'] = "Export Control Acces";
$text['header-access_control_export']['ru-ru'] = "Экспорт контроля доступа";
$text['header-access_control_export']['sv-se'] = "Exporteringskontroll för åtkomst";
$text['header-access_control_export']['uk-ua'] = "Експорт керування доступом";
$text['header-access_control_export']['tr-tr'] = "Erişim Kontrolu Dışa Aktarımı";
$text['header-access_control_export']['zh-cn'] = "导出访问控制";
$text['header-access_control_export']['ja-jp'] = "アクセス制御のエクスポート";
