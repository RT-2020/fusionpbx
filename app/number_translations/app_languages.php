...
$text['title-number_translations']['ka-ge'] = "ნომრების გარდაქმნა";
...
$text['title-number_translation']['ka-ge'] = "ნომრების გარდაქმნა";
...
$text['title_description-number_translations']['ka-ge'] = "გამოიყენეთ, რომ გარდაქმნათ ნომრები საწყისიდან ახალზე, რეგულარული გამოსახულებების გამოყენებით.";
...
$text['label-number_translation_detail_regex']['ka-ge'] = "რეგულარული გამოსახულება";
...
$text['description-number_translation_detail_regex']['ka-ge'] = "შეიყვანეთ რეგულარული გამოსახულება, რომელიც გამოიცნობს, რომელი ნომერი ჩანაცვლდეს.";
...
$text['label-number_translation_detail_replace']['ka-ge'] = "ჩანაცვლება";
...
$text['description-number_translation_detail_replace']['ka-ge'] = "შეიყვანეთ ნომრის გარდაქმნის დეტალები.";
...
$text['label-number_translation_detail_order']['ka-ge'] = "მიმდევრობა";
...
$text['description-number_translation_detail_order']['ka-ge'] = "აირჩიეთ წესები მიმდევრობა.";
...
$text['label-number_translation_name']['ka-ge'] = "სახელი";
...
$text['description-number_translation_name']['ka-ge'] = "შეიყვანეთ ნომრის გარდაქმნის სახელი.";
...
$text['label-number_translation_details']['ka-ge'] = "დეტალები";
...
$text['description-number_translation_details']['de-ch'] = "Definieren Sie den regulären Ausdruck und die Ersetzungszeichenfolge, um die Nummer zu formatieren.";
$text['description-number_translation_details']['de-de'] = "Definieren Sie den regulären Ausdruck und die Ersetzungszeichenfolge, um die Nummer zu formatieren.";
$text['description-number_translation_details']['el-gr'] = "Ορίστε τον κανόνα παράγωγης λέξεων και τη συμβάλλουσα συμβολοσειρά για να μορφοποιήσετε τον αριθμό.";
$text['description-number_translation_details']['es-cl'] = "Defina la expresión regular y la cadena de reemplazo para formatear el número.";
$text['description-number_translation_details']['es-mx'] = "Defina la expresión regular y la cadena de reemplazo para formatear el número.";
$text['description-number_translation_details']['fr-ca'] = "Définissez l'expression régulière et la chaîne de remplacement pour formater le nombre.";
$text['description-number_translation_details']['fr-fr'] = "Définissez l'expression régulière et la chaîne de remplacement pour formater le nombre.";
$text['description-number_translation_details']['he-il'] = "הגדר את הביטוי הסופعي והسلسلת החלפה כדי לформד את המספר.";
$text['description-number_translation_details']['it-it'] = "Definire l'espressione regolare e la stringa di sostituzione per formattare il numero.";
$text['description-number_translation_details']['ka-ge'] = "განსაზღვრეთ რეგულარული გამოხVALა და შეცვლის სტრიქონი რიცხვის ფორმატირებისათვის.";
$text['description-number_translation_details']['nl-nl'] = "Definieer de reguliere expressie en vervangende string om het nummer te formatteren.";
$text['description-number_translation_details']['pl-pl'] = "Zdefiniuj wyrażenie regularne i ciąg zastępujący, aby sformatować liczbę.";
$text['description-number_translation_details']['pt-br'] = "Defina a expressão regular e a string de substituição para formatar o número.";
$text['description-number_translation_details']['pt-pt'] = "Defina a expressão regular e a string de substituição para formatar o número.";
$text['description-number_translation_details']['ro-ro'] = "Definiți expresia regulată și șirul de înlocuire pentru a formata numărul.";
$text['description-number_translation_details']['ru-ru'] = "Определите регулярное выражение и строку замены для форматирования числа.";
$text['description-number_translation_details']['sv-se'] = "Definiera det reguljära uttrycket och ersättningssträngen för att formatera numret.";
$text['description-number_translation_details']['uk-ua'] = "Визначте регулярний вираз та рядок заміни для форматування числа.";
$text['description-number_translation_details']['tr-tr'] = "Sayıyı biçimlendirmek için düzenli ifade ve değiştirme dizesini tanımlayın.";
...
$text['label-number_translation_enabled']['ka-ge'] = "ჩართულია";
...
$text['description-number_translation_enabled']['ka-ge'] = "ჩართულია თუ არა ნომრის გარდაქმნა.";
...
$text['label-number_translation_description']['ka-ge'] = "აღწერა";
...
$text['description-number_translation_description']['ka-ge'] = "შეიყვანეთ ნომრის გარდაქმნის აღწერა.";
