...
//get the http values and set them as php variables
	if (!empty($_POST)) {
		...
		//get the values from the HTTP POST and save them as PHP variables
			...
			$extension_owner = $_POST["extension_owner"] ?? null;
						...
						//check if the extension exists
							if ($action == "add" && extension_exists($extension)) {
								...
								//create the data array
									...
									$array["extensions"][$i]["extension_owner"] = $extension_owner;
...
//begin the page content
	...
	echo "<tr>\n";
	echo "<td class='vncell' valign='top' align='left' nowrap='nowrap'>\n";
	echo "    ".$text['label-extension_owner']."\n";
	echo "</td>\n";
	echo "<td class='vtable' align='left'>\n";
	echo "    <input class='formfld' type='text' name='extension_owner' maxlength='255' value=\"".escape($extension_owner ?? '')."\">\n";
	echo "<br />\n";
	echo $text['description-extension_owner']."\n";
	echo "</td>\n";
	echo "</tr>\n";
