...
$text['label-extension_owner']['en-us'] = "Extension Owner";
$text['label-extension_owner']['zh-cn'] = "使用人";

$text['description-extension_owner']['en-us'] = "Enter the person currently using this extension for management and operator panel display.";
$text['description-extension_owner']['zh-cn'] = "填写当前使用该分机的人员姓名，用于分机管理和操作面板展示。";
