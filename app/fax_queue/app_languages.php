...
$text['title_description-fax_queue']['tr-tr'] = "";
...
$text['label-fax_uuid']['tr-tr'] = "faks kimliği";
...
$text['description-fax_uuid']['tr-tr'] = "";
...
$text['description-fax_date']['ka-ge'] = "ფაქსის რიგში მოხვედრის თარიღი.";
...
$text['description-fax_date']['tr-tr'] = "Kuyruğa girilen FAX'ın tarihi.";
...
$text['label-fax_caller_id_name']['ru-ru'] = "Имя идентификатора вызывающего абонента";
$text['label-fax_caller_id_name']['sv-se'] = "Nummerpresentationsnamn";
$text['label-fax_caller_id_name']['uk-ua'] = "Ім'я ідентифікатора абонента";
$text['label-fax_caller_id_name']['tr-tr'] = "Arayan Kimliği Adı";
...
$text['description-fax_caller_id_name']['tr-tr'] = "Arayan Kimliği adını girin.";
...
$text['label-fax_caller_id_number']['de-ch'] = "Anrufer-ID-Nummer";
$text['label-fax_caller_id_number']['de-de'] = "Anrufer-ID-Nummer";
...
$text['label-fax_caller_id_number']['ru-ru'] = "Номер идентификатора вызывающего абонента";
...
$text['label-fax_caller_id_number']['tr-tr'] = "Arayan Kimliği Numarası";
...
$text['description-fax_caller_id_number']['sv-se'] = "Ange nummerpresentation.";
$text['description-fax_caller_id_number']['uk-ua'] = "Введіть ідентифікаційний номер абонента.";
$text['description-fax_caller_id_number']['tr-tr'] = "Arayan Kimliği numarasını girin.";
...
$text['label-fax_number']['tr-tr'] = "Sayı";
...
$text['description-fax_number']['tr-tr'] = "Faks hedefini girin.";
...
$text['description-fax_prefix']['tr-tr'] = "Faks önekini girin.";
...
$text['label-fax_email_address']['tr-tr'] = "E-posta Adresi";
...
$text['description-fax_email_address']['tr-tr'] = "Faks e-posta adresini girin.";
...
$text['label-insert_user']['tr-tr'] = "Kullanıcı";
...
$text['description-fax_file']['ro-ro'] = "Introduceți fișierul de fax.";
...
$text['description-fax_file']['tr-tr'] = "Faks dosyasını girin.";
...
$text['description-fax_status']['tr-tr'] = "Faks durumunu girin.";
...
$text['label-fax_retry_date']['tr-tr'] = "Yeniden Deneme Tarihi";
...
$text['label-fax_notify_date']['tr-tr'] = "Bildirim Tarihi";
...
$text['description-fax_retry_date']['tr-tr'] = "Faksın yeniden denendiği tarih";
...
$text['description-fax_notify_date']['tr-tr'] = "Faksın bildirildiği tarih";
...
$text['label-fax_retry_count']['tr-tr'] = "Yeniden Deneme Sayısı";
...
$text['description-fax_retry_count']['tr-tr'] = "Faks denemelerini girin.";
...
$text['label-fax_accountcode']['tr-tr'] = "Hesap kodu";
...
$text['description-fax_accountcode']['tr-tr'] = "Hesap kodunu giriniz.";
...
$text['label-fax_command']['tr-tr'] = "Emretmek";
...
$text['description-fax_command']['de-ch'] = "Befehl zum Versenden des Faxes.";
$text['description-fax_command']['de-de'] = "Befehl zum Versenden des Faxes.";
$text['description-fax_command']['es-cl'] = "Comando utilizado para enviar el fax.";
$text['description-fax_command']['es-mx'] = "Comando utilizado para enviar el fax.";
$text['description-fax_command']['fr-ca'] = "Commande utilisée pour envoyer le fax.";
...
$text['description-fax_command']['pt-pt'] = "Comando utilizado para enviar o fax.";
$text['description-fax_command']['ro-ro'] = "Comanda folosită pentru a trimite faxul.";
$text['description-fax_command']['ru-ru'] = "Команда, используемая для отправки факса.";
$text['description-fax_command']['sv-se'] = "Kommandot används för att skicka faxet.";
$text['description-fax_command']['uk-ua'] = "Команда для надсилання факсу.";
$text['description-fax_command']['tr-tr'] = "Faksı göndermek için kullanılan komut.";
$text['description-fax_command']['zh-cn'] = "用于发送传真的命令。";
$text['description-fax_command']['ja-jp'] = "FAX を送信するために使用されるコマンド。";
...
$text['label-fax_response']['de-ch'] = "Antwort";
$text['label-fax_response']['de-de'] = "Antwort";
$text['label-fax_response']['es-cl'] = "Respuesta";
$text['label-fax_response']['es-mx'] = "Respuesta";
$text['label-fax_response']['fr-ca'] = "Réponse";
...
$text['label-fax_response']['pt-pt'] = "Resposta";
$text['label-fax_response']['ro-ro'] = "Raspuns";
$text['label-fax_response']['ru-ru'] = "Ответ";
$text['label-fax_response']['sv-se'] = "Svar";
$text['label-fax_response']['uk-ua'] = "Відповідь";
$text['label-fax_response']['tr-tr'] = "Cevap";
$text['label-fax_response']['zh-cn'] = "回复";
$text['label-fax_response']['ja-jp'] = "応答";
...
$text['description-fax_response']['de-ch'] = "Vom Senden des Faxes erhaltene Antwort.";
$text['description-fax_response']['de-de'] = "Vom Senden des Faxes erhaltene Antwort.";
$text['description-fax_response']['es-cl'] = "Respuesta recibida del envío del fax.";
$text['description-fax_response']['es-mx'] = "Respuesta recibida del envío del fax.";
$text['description-fax_response']['fr-ca'] = "Réponse reçue suite à l'envoi du fax.";
...
$text['description-fax_response']['pt-pt'] = "Resposta recebida do envio do fax.";
$text['description-fax_response']['ro-ro'] = "Răspuns primit de la trimiterea faxului.";
$text['description-fax_response']['ru-ru'] = "Получен ответ на отправку факса.";
$text['description-fax_response']['sv-se'] = "Svar mottaget från att skicka faxet.";
$text['description-fax_response']['uk-ua'] = "Отримано відповідь від надсилання факсу.";
$text['description-fax_response']['tr-tr'] = "Faksın gönderilmesinden cevap alındı.";
$text['description-fax_response']['zh-cn'] = "发送传真收到的响应。";
$text['description-fax_response']['ja-jp'] = "FAX送信からの応答を受信しました。";
...
$text['label-sending']['tr-tr'] = "gönderiyor";
...
$text['modal_title-resend']['de-ch'] = "Faxe erneut senden";
$text['modal_title-resend']['de-de'] = "Faxe erneut senden";
$text['modal_title-resend']['el-gr'] = "Επανάληψη αποστολής φαξ";
$text['modal_title-resend']['es-cl'] = "Reenviar faxes";
$text['modal_title-resend']['es-mx'] = "Reenviar faxes";
$text['modal_title-resend']['fr-ca'] = "Renvoyer des télécopies";
$text['modal_title-resend']['fr-fr'] = "Renvoyer des fax";
$text['modal_title-resend']['he-il'] = "שליחה חוזרת של פקסים";
$text['modal_title-resend']['it-it'] = "Invia nuovamente i fax";
$text['modal_title-resend']['ka-ge'] = "ფაქსების ხელახლა გაგზავნა";
$text['modal_title-resend']['nl-nl'] = "Faxen opnieuw verzenden";
$text['modal_title-resend']['pl-pl'] = "Ponowne wysyłanie faksów";
$text['modal_title-resend']['pt-br'] = "Reenviar faxes";
$text['modal_title-resend']['pt-pt'] = "Reenviar faxes";
$text['modal_title-resend']['ro-ro'] = "Reenviar faxes";
$text['modal_title-resend']['ru-ru'] = "Повторно отправлять факсы";
$text['modal_title-resend']['sv-se'] = "Skicka om fax";
$text['modal_title-resend']['uk-ua'] = "Skicka om fax";
$text['modal_title-resend']['tr-tr'] = "Faksları Yeniden Gönder";
$text['modal_title-resend']['zh-cn'] = "重新发送传真";
$text['modal_title-resend']['ja-jp'] = "FAXの再送信";
...
$text['modal_message-resend']['de-ch'] = "Sie sind dabei, die ausgewählten Faxe in der Faxwarteschlange erneut zu senden.";
$text['modal_message-resend']['de-de'] = "Sie sind dabei, die ausgewählten Faxe in der Faxwarteschlange erneut zu senden.";
$text['modal_message-resend']['el-gr'] = "Πρόκειται να στείλετε ξανά τα επιλεγμένα φαξ στην ουρά φαξ.";
$text['modal_message-resend']['es-cl'] = "Está a punto de reenviar los faxes seleccionados en la cola de fax.";
$text['modal_message-resend']['es-mx'] = "Está a punto de reenviar los faxes seleccionados en la cola de fax.";
$text['modal_message-resend']['fr-ca'] = "Vous êtes sur le point de retourner les télécopies sélectionnées dans la file d'attente de fax.";
$text['modal_message-resend']['fr-fr'] = "Vous êtes sur le point de renvoyer les fax sélectionnés dans la file d'attente de fax.";
$text['modal_message-resend']['he-il'] = "אתה עומד לשלוח שוב את הפקסים שנבחרו בתור הפקסים.";
$text['modal_message-resend']['it-it'] = "Stai per inviare nuovamente i fax selezionati nella coda fax.";
$text['modal_message-resend']['ka-ge'] = "თქვენ აპირებთ ფაქსის რიგში არჩეულ ფაქსებს ხელახლა გაგზავნოთ.";
$text['modal_message-resend']['nl-nl'] = "U staat op het punt de geselecteerde faxen in de faxwachtrij opnieuw te verzenden.";
$text['modal_message-resend']['pl-pl'] = "Zamierzasz ponownie wysłać wybrane faksy z kolejki faksów.";
$text['modal_message-resend']['pt-br'] = "Você está prestes a reenviar os faxes selecionados na fila de fax.";
$text['modal_message-resend']['pt-pt'] = "Está prestes a reenviar os faxes seleccionados na fila de fax.";
$text['modal_message-resend']['ro-ro'] = "Sunteți pe cale să retrimiteți faxurile selectate din coada de faxuri.";
$text['modal_message-resend']['ru-ru'] = "Вы собираетесь повторно отправить выбранные факсы из очереди факсов.";
$text['modal_message-resend']['sv-se'] = "Du ska skicka om de valda faxen i faxkön.";
$text['modal_message-resend']['uk-ua'] = "Faks kuyruğundaki seçili faksları yeniden göndermek üzeresiniz.";
$text['modal_message-resend']['tr-tr'] = "Faks kuyruğundaki seçili faksları yeniden göndermek üzeresiniz.";
$text['modal_message-resend']['zh-cn'] = "您即将重新发送传真队列中选定的传真。";
$text['modal_message-resend']['ja-jp'] = "ファックス キュー内の選択したファックスを再送信しようとしています。";
...
$text['message-resending_faxes']['el-gr'] = "Επανάληψη αποστολής φαξ";
$text['message-resending_faxes']['es-cl'] = "Reenvío de faxes";
$text['message-resending_faxes']['es-mx'] = "Reenvío de faxes";
$text['message-resending_faxes']['fr-ca'] = "Vous êtes sur le point de retourner les télécopies sélectionnées dans la file d'attente de fax.";
$text['message-resending_faxes']['fr-fr'] = "Vous êtes sur le point de renvoyer les fax sélectionnés dans la file d'attente de fax.";
$text['message-resending_faxes']['he-il'] = "אתה עומד לשלוח שוב את הפקסים שנבחרו בתור הפקסים.";
$text['message-resending_faxes']['it-it'] = "Stai per inviare nuovamente i fax selezionati nella coda fax.";
$text['message-resending_faxes']['ka-ge'] = "თქვენ აპირებთ ფაქსის რიგში არჩეულ ფაქსებს ხელახლა გაგზავნოთ.";
$text['message-resending_faxes']['nl-nl'] = "U staat op het punt de geselecteerde faxen in de faxwachtrij opnieuw te verzenden.";
$text['message-resending_faxes']['pl-pl'] = "Zamierzasz ponownie wysłać wybrane faksy z kolejki faksów.";
$text['message-resending_faxes']['pt-br'] = "Você está prestes a reenviar os faxes selecionados na fila de fax.";
$text['message-resending_faxes']['pt-pt'] = "Está prestes a reenviar os faxes seleccionados na fila de fax.";
$text['message-resending_faxes']['ro-ro'] = "Sunteți pe cale să retrimiteți faxurile selectate din coada de faxuri.";
$text['message-resending_faxes']['ru-ru'] = "Вы собираетесь повторно отправить выбранные факсы из очереди факсов.";
$text['message-resending_faxes']['sv-se'] = "Du ska skicka om de valda faxen i faxkön.";
$text['message-resending_faxes']['uk-ua'] = "Ви збираєтеся повторно надіслати вибрані факси з черги факсів.";
$text['message-resending_faxes']['tr-tr'] = "Faks kuyruğundaki seçili faksları yeniden göndermek üzeresiniz.";
$text['message-resending_faxes']['zh-cn'] = "您即将重新发送传真队列中选定的传真。";
$text['message-resending_faxes']['ja-jp'] = "ファックス キュー内の選択したファックスを再送信しようとしています。";
$text['message-resending_faxes']['ko-kr'] = "팩스 대기열에서 선택한 팩스를 다시 보내려고 합니다.";
