<?php
	...
	//permission details
		...
		$apps[$x]['permissions'][$y]['groups'][] = "admin";
		$y++;
		$apps[$x]['permissions'][$y]['name'] = "conference_authorized_extension_add";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$apps[$x]['permissions'][$y]['groups'][] = "admin";
		$y++;
		$apps[$x]['permissions'][$y]['name'] = "conference_authorized_extension_edit";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$apps[$x]['permissions'][$y]['groups'][] = "admin";
		$y++;
		$apps[$x]['permissions'][$y]['name'] = "conference_authorized_extension_delete";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$apps[$x]['permissions'][$y]['groups'][] = "admin";
	...
	//schema details
        ...
        $apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
        $apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Call mode: single_call, group_call, or all_call.";
        $z++;
        // target extension uuid used when call_mode is group_call
        $apps[$x]['db'][$y]['fields'][$z]['name'] = "call_mode_group_uuid";
        $apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "uuid";
        $apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
        $apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "char(36)";
        $apps[$x]['db'][$y]['fields'][$z]['key']['type'] = "foreign";
        ...
        $apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Target extension for group_call mode.";
        $z++;
        $apps[$x]['db'][$y]['fields'][$z]['name'] = "call_mode_targets";
        $apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
        $apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "多个分机号，英文逗号分隔";
        $z++;
        $apps[$x]['db'][$y]['fields'][$z]['name'] = "call_mode_exclude_caller";
        $apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
        $apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "排除主叫（true/false）";
        $z++;
	...
	$y++;
	$apps[$x]['db'][$y]['table']['name'] = "v_conference_authorized_extensions";
	$apps[$x]['db'][$y]['table']['parent'] = "v_conferences";
	$z=0;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_authorized_extension_uuid";
	$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "uuid";
	$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
	$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "char(36)";
	$z++;
	...
	$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "char(36)";
    $y++;
    $apps[$x]['db'][$y]['table']['name'] = "v_conference_authorization_logs";
	$apps[$x]['db'][$y]['table']['parent'] = "v_conferences";
	$z=0;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_authorization_log_uuid";
	$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "uuid";
	$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
	$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "char(36)";
	$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Primary key for authorization audit logs.";
	$z++;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "domain_uuid";
	$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "uuid";
	$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
	...
	$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "char(36)";
	$z++;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "user_uuid_resolved";
	$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "uuid";
	$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
	$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "char(36)";
	$z++;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "extension_uuid_resolved";
	$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "uuid";
	$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
	$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "char(36)";
	$z++;
	...
	$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
	$z++;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "sip_from_user";
	$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
	$z++;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "sip_user_agent";
	$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
	$z++;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "network_addr";
	$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
	$z++;
	$apps[$x]['db'][$y]['fields'][$z]['name'] = "authorized";
	$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
	$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Authorization check result.";
	$z++;
