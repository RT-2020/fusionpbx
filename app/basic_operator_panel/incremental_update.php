...
//get extensions from the database
	$sql = "select e.extension, e.effective_caller_id_name, e.extension_owner, e.description, e.enabled, ";
	...
	if ($search_filter != '') {
		$sql .= "and (e.extension like :search_filter or e.effective_caller_id_name like :search_filter or e.extension_owner like :search_filter or e.description like :search_filter) ";
	}
