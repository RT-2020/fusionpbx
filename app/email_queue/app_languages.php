...
$text['modal_message-resend']['de-ch'] = "Sie sind dabei, die ausgewählten Nachrichten in der E-Mail-Warteschlange erneut zu senden.";
$text['modal_message-resend']['de-de'] = "Sie sind dabei, die ausgewählten Nachrichten in der E-Mail-Warteschlange erneut zu senden.";
$text['modal_message-resend']['el-gr'] = "Πρόκειται να στείλετε ξανά τα επιλεγμένα μηνύματα στην ουρά email.";
$text['modal_message-resend']['es-cl'] = "Está a punto de reenviar los mensajes seleccionados en la cola de correo electrónico.";
$text['modal_message-resend']['es-mx'] = "Está a punto de reenviar los mensajes seleccionados en la cola de correo electrónico.";
$text['modal_message-resend']['fr-ca'] = "Vous êtes sur le point de retourner les messages sélectionnés dans la file d'attente des e-mails.";
$text['modal_message-resend']['fr-fr'] = "Vous êtes sur le point de renvoyer les messages sélectionnés dans la file d'attente des e-mails.";
$text['modal_message-resend']['he-il'] = 'אתה עומד לשלוח מחדש את ההודעות שנבחרו בתור הדוא"ל.';
$text['modal_message-resend']['it-it'] = "Stai per inviare nuovamente i messaggi selezionati nella coda di posta elettronica.";
$text['modal_message-resend']['ka-ge'] = "თქვენ აპირებთ ელფოსტის რიგში არჩეულ შეტყობინებებს ხელახლა გაგზავნოთ.";
$text['modal_message-resend']['nl-nl'] = "U staat op het punt om de geselecteerde berichten in de e-mailwachtrij opnieuw te verzenden.";
$text['modal_message-resend']['pl-pl'] = "Zamierzasz ponownie wysłać wybrane wiadomości z kolejki wiadomości e-mail.";
$text['modal_message-resend']['pt-br'] = "Ești pe cale să retrimiți mesajele selectate din coada de e-mailuri.";
$text['modal_message-resend']['pt-pt'] = "Está prestes a reenviar as mensagens selecionadas na fila de e-mails.";
$text['modal_message-resend']['ro-ro'] = "Ești pe cale să retrimiți mesajele selectate din coada de e-mailuri.";
$text['modal_message-resend']['ru-ru'] = "Вы собираетесь повторно отправить выбранные сообщения в очереди электронной почты.";
$text['modal_message-resend']['sv-se'] = "Du ska skicka om de markerade meddelandena i e-postkön.";
$text['modal_message-resend']['uk-ua'] = "Ви збираєтеся повторно надіслати вибрані повідомлення з черги електронної пошти.";
$text['modal_message-resend']['tr-tr'] = "E-posta kuyruğundaki seçili mesajları yeniden göndermek üzeresiniz.";
$text['modal_message-resend']['zh-cn'] = "您即将重新发送电子邮件队列中选定的消息。";
$text['modal_message-resend']['ja-jp'] = "電子メール キュー内の選択したメッセージを再送信しようとしています。";
...
$text['message-resending_messages']['de-ch'] = "Nachrichten erneut senden";
$text['message-resending_messages']['de-de'] = "Nachrichten erneut senden";
$text['message-resending_messages']['el-gr'] = "Επανάληψη αποστολής μηνυμάτων";
$text['message-resending_messages']['es-cl'] = "Reenviar mensajes";
$text['message-resending_messages']['es-mx'] = "Reenviar mensajes";
$text['message-resending_messages']['fr-ca'] = "Renvoyer des messages";
$text['message-resending_messages']['fr-fr'] = "Renvoyer des messages";
$text['message-resending_messages']['he-il'] = "שליחה חוזרת של הודעות";
$text['message-resending_messages']['it-it'] = "Reinvio dei messaggi";
$text['message-resending_messages']['ka-ge'] = "შეტყობინებების ხელახლა გაგზავნა";
$text['message-resending_messages']['nl-nl'] = "Berichten opnieuw verzenden";
$text['message-resending_messages']['pl-pl'] = "Ponowne wysyłanie wiadomości";
$text['message-resending_messages']['pt-br'] = "Reenviando mensagens";
$text['message-resending_messages']['pt-pt'] = "Reenviando mensagens";
$text['message-resending_messages']['ro-ro'] = "Retrimiterea mesajelor";
$text['message-resending_messages']['ru-ru'] = "Повторная отправка сообщений";
$text['message-resending_messages']['sv-se'] = "Skicka meddelanden igen";
$text['message-resending_messages']['uk-ua'] = "Повторне надсилання повідомлень";
$text['message-resending_messages']['tr-tr'] = "Mesajları Yeniden Gönderme";
