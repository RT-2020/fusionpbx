...
$text['label-available']['de-ch'] = "Verfügbar";
$text['label-available']['de-de'] = "Verfügbar";
$text['label-available']['el-gr'] = "Διαθέσιμο";
$text['label-available']['es-cl'] = "Disponible";
$text['label-available']['es-mx'] = "Disponible";
$text['label-available']['fr-ca'] = "Disponible";
$text['label-available']['fr-fr'] = "Disponible";
$text['label-available']['he-il'] = "זמין";
$text['label-available']['it-it'] = "Disponibile";
$text['label-available']['ka-ge'] = "ხელმានია";
$text['label-available']['nl-nl'] = "Beschikbaar";
$text['label-available']['pl-pl'] = "Dostępny";
$text['label-available']['pt-br'] = "Disponível";
$text['label-available']['pt-pt'] = "Disponível";
$text['label-available']['ro-ro'] = "Disponibil";
$text['label-available']['ru-ru'] = "Доступно";
$text['label-available']['sv-se'] = "Tillgänglig";
$text['label-available']['uk-ua'] = "Доступний";
$text['label-available']['tr-tr'] = "Kullanılabilir";
$text['label-available']['zh-cn'] = "可用";
$text['label-available']['ja-jp'] = "利用可能";
...
$text['label-available_on_demand']['de-ch'] = "Verfügbar (auf Anfrage)";
$text['label-available_on_demand']['de-de'] = "Verfügbar (auf Anfrage)";
$text['label-available_on_demand']['el-gr'] = "Διαθέσιμο (κατά πρότυπο)";
$text['label-available_on_demand']['es-cl'] = "Disponible (A petición)";
$text['label-available_on_demand']['es-mx'] = "Disponible (A petición)";
$text['label-available_on_demand']['fr-ca'] = "Disponible (À la demande)";
$text['label-available_on_demand']['fr-fr'] = "Disponible (À la demande)";
$text['label-available_on_demand']['he-il'] = "זמין (לפי בקשה)";
$text['label-available_on_demand']['it-it'] = "Disponibile (su richiesta)";
$text['label-available_on_demand']['ka-ge'] = "ხელმასնიანი (შეკვეთის ფუძის)" ;
$text['label-available_on_demand']['nl-nl'] = "Beschikbaar (op aanvraag)";
$text['label-available_on_demand']['pl-pl'] = "Dostępny (na żądanie)";
$text['label-available_on_demand']['pt-br'] = "Disponível (Sob Demanda)";
$text['label-available_on_demand']['pt-pt'] = "Disponível (Por Pedido)";
$text['label-available_on_demand']['ro-ro'] = "Disponibil (Pe Cerere)";
$text['label-available_on_demand']['ru-ru'] = "Доступно (по запросу)";
$text['label-available_on_demand']['sv-se'] = "Tillgänglig (på begäran)";
$text['label-available_on_demand']['uk-ua'] = "Доступний (за запитом)";
$text['label-available_on_demand']['tr-tr'] = "İsteğe Göre Kullanılabilir";
$text['label-available_on_demand']['zh-cn'] = "按需可用";
$text['label-available_on_demand']['ja-jp'] = "需要時に利用可能";
...
$text['label-not_available']['de-ch'] = "Nicht verfügbar";
$text['label-not_available']['de-de'] = "Nicht verfügbar";
$text['label-not_available']['el-gr'] = "Μη Διαθέσιμο";
$text['label-not_available']['es-cl'] = "No disponible";
$text['label-not_available']['es-mx'] = "No disponible";
$text['label-not_available']['fr-ca'] = "Non disponible";
$text['label-not_available']['fr-fr'] = "Non disponible";
$text['label-not_available']['he-il'] = "לא זמין";
$text['label-not_available']['it-it'] = "Non disponibile";
$text['label-not_available']['ka-ge'] = "უხელმასწავლებელი";
$text['label-not_available']['nl-nl'] = "Niet beschikbaar";
$text['label-not_available']['pl-pl'] = "Niedostępny";
$text['label-not_available']['pt-br'] = "Indisponível";
$text['label-not_available']['pt-pt'] = "Indisponível";
$text['label-not_available']['ro-ro'] = "Indisponibil";
$text['label-not_available']['ru-ru'] = "Недоступно";
$text['label-not_available']['sv-se'] = "Inte tillgänglig";
$text['label-not_available']['uk-ua'] = "Недоступний";
$text['label-not_available']['tr-tr'] = "Kullanılamıyor";
$text['label-not_available']['zh-cn'] = "不可用";
$text['label-not_available']['ja-jp'] = "利用できません";
...
$text['label-on_break']['de-ch'] = "Pause";
$text['label-on_break']['de-de'] = "Pause";
$text['label-on_break']['el-gr'] = "Παύση";
$text['label-on_break']['es-cl'] = "En pausa";
$text['label-on_break']['es-mx'] = "En pausa";
$text['label-on_break']['fr-ca'] = "Pause";
$text['label-on_break']['fr-fr'] = "Pause";
$text['label-on_break']['he-il'] = "במנוחה";
$text['label-on_break']['it-it'] = "In pausa";
$text['label-on_break']['ka-ge'] = "კავშირება პაუზაში";
$text['label-on_break']['nl-nl'] = "Pauze";
$text['label-on_break']['pl-pl'] = "Na przerwie";
$text['label-on_break']['pt-br'] = "Em pausa";
$text['label-on_break']['pt-pt'] = "Em pausa";
$text['label-on_break']['ro-ro'] = "În pauză";
$text['label-on_break']['ru-ru'] = "Перерыв";
$text['label-on_break']['sv-se'] = "Paus";
$text['label-on_break']['uk-ua'] = "В паузі";
$text['label-on_break']['tr-tr'] = "Mola";
$text['label-on_break']['zh-cn'] = "休息中";
$text['label-on_break']['ja-jp'] = "休憩中";
...
$text['label-logged_out']['de-ch'] = "Abgemeldet";
$text['label-logged_out']['de-de'] = "Abgemeldet";
$text['label-logged_out']['el-gr'] = "Αποσυνδεδεμένος";
$text['label-logged_out']['es-cl'] = "Desconectado";
$text['label-logged_out']['es-mx'] = "Desconectado";
$text['label-logged_out']['fr-ca'] = "Déconnecté";
$text['label-logged_out']['fr-fr'] = "Déconnecté";
$text['label-logged_out']['he-il'] = "התנתק";
$text['label-logged_out']['it-it'] = "Disconnesso";
$text['label-logged_out']['ka-ge'] = "გამოსვლილი";
$text['label-logged_out']['nl-nl'] = "Afgemeld";
$text['label-logged_out']['pl-pl'] = "Wylogowany";
$text['label-logged_out']['pt-br'] = "Desconectado";
$text['label-logged_out']['pt-pt'] = "Desconectado";
$text['label-logged_out']['ro-ro'] = "Deconectat";
$text['label-logged_out']['ru-ru'] = "Вышел из системы";
$text['label-logged_out']['sv-se'] = "Utloggad";
$text['label-logged_out']['uk-ua'] = "Вийшов з системи";
$text['label-logged_out']['tr-tr'] = "Çıkış Yapıldı";
$text['label-logged_out']['zh-cn'] = "已注销";
$text['label-logged_out']['ja-jp'] = "ログアウト";
$text['label-logged_out']['ko-kr'] = "로그아웃됨";
