...
$text['label-update_greeting']['de-ch'] = "Aktualisieren";
$text['label-update_greeting']['de-de'] = "Aktualisieren";
$text['label-update_greeting']['el-gr'] = "Εκσυγχρονίζω";
$text['label-update_greeting']['es-cl'] = "Actualizar";
$text['label-update_greeting']['es-mx'] = "Actualizar";
$text['label-update_greeting']['fr-ca'] = "Mise à jour";
$text['label-update_greeting']['fr-fr'] = "Mise à jour";
$text['label-update_greeting']['he-il'] = "לְעַדְכֵּן";
$text['label-update_greeting']['it-it'] = "Aggiornamento";
$text['label-update_greeting']['ka-ge'] = "განახლების შეტყობინება";
$text['label-update_greeting']['nl-nl'] = "Update";
$text['label-update_greeting']['pl-pl'] = "Aktualizacja";
$text['label-update_greeting']['pt-br'] = "Atualizar";
$text['label-update_greeting']['pt-pt'] = "Atualização";
$text['label-update_greeting']['ro-ro'] = "Actualizare";
$text['label-update_greeting']['ru-ru'] = "Обновлять";
$text['label-update_greeting']['sv-se'] = "Uppdatera";
$text['label-update_greeting']['uk-ua'] = "Оновлення";
$text['label-update_greeting']['tr-tr'] = "Güncelleme";
$text['label-update_greeting']['zh-cn'] = "更新";
$text['label-update_greeting']['ja-jp'] = "アップデート";
...
$text['description-update_greeting']['de-ch'] = "Wenn aktiviert, wird eine Begrüßung erstellt, um die vorherige zu ersetzen.";
$text['description-update_greeting']['de-de'] = "Wenn aktiviert, wird eine Begrüßung erstellt, um die vorherige zu ersetzen.";
$text['description-update_greeting']['el-gr'] = "Όταν ενεργοποιηθεί, θα δημιουργηθεί μια χαιρετισμός για να αντικαταστήσει τον προηγούμενο.";
$text['description-update_greeting']['es-cl'] = "Al habilitarse, se creará un saludo para reemplazar el anterior.";
$text['description-update_greeting']['es-mx'] = "Al habilitarse, se creará un saludo para reemplazar el anterior.";
$text['description-update_greeting']['fr-ca'] = "Lors de l'activation, un salut d'accueil sera créé pour remplacer le précédent.";
$text['description-update_greeting']['fr-fr'] = "Lors de l'activation, un message de bienvenue sera créé pour remplacer le précédent.";
$text['description-update_greeting']['he-il'] = "כשזה מופעל, תיווצר ברכה כדי להחליף את הקודמת.";
$text['description-update_greeting']['it-it'] = "Quando abilitato, verrà creato un saluto per sostituire il precedente.";
$text['description-update_greeting']['ka-ge'] = "გამოყენებისას შექმნილი იქნება გმადლობები, რომ წინა ერთს შეიცვალოს.";
$text['description-update_greeting']['nl-nl'] = "Wanneer ingeschakeld, wordt een groet gemaakt om de vorige te vervangen.";
$text['description-update_greeting']['pl-pl'] = "Po włączeniu utworzony zostanie powitanie, aby zastąpić poprzednie.";
$text['description-update_greeting']['pt-br'] = "Ao ser habilitado, um cumprimento será criado para substituir o anterior.";
$text['description-update_greeting']['pt-pt'] = "Ao ser ativado, será criado um cumprimento para substituir o anterior.";
$text['description-update_greeting']['ro-ro'] = "Când este activat, va fi creat un salut pentru a înlocui cel anterior.";
$text['description-update_greeting']['ru-ru'] = "При включении будет создан приветствие, чтобы заменить предыдущее.";
$text['description-update_greeting']['sv-se'] = "När det är aktiverat, skapas ett hälsningsmeddelande för att ersätta det tidigare.";
$text['description-update_greeting']['uk-ua'] = "При увімкненні буде створено вітання, щоб замінювати попереднє.";
$text['description-update_greeting']['tr-tr'] = "Etkinleştirildiğinde, öncekiyi değiştirmek için bir selam oluşturulur.";
$text['description-update_greeting']['zh-cn'] = "启用时，将创建一个问候来替换之前的问候。";
$text['description-update_greeting']['ja-jp'] = "有効にすると、前のものを置き換える挨拶が作成されます。";
$text['description-update_greeting']['ko-kr'] = "활성화되면 이전 것을 대체하는 인사 메시지가 생성됩니다.";