	...
	//menu container
		...
		//build menu by style
			switch ($_SESSION['theme']['menu_style']['text']) {
				case 'side':
					$view->assign('menu_side_state', 'expanded');
					$menu_side_toggle = null;
					$container_open = "<div id='menu_side_container' style='width: ".($_SESSION['theme']['menu_side_width_expanded']['text'] ?? 225)."px;' class='hide-xs' >\n";
					$menu = new menu;
					$menu->text = $text;
